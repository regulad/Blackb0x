...
#include <sys/mman.h>
#else
/* dlfcn.h/sys/mman.h are unused in this file (dlopen/mmap never actually
 * called — mpo_file_check_mmap below is just a mac_policy_ops struct field
 * name); the Mach-O struct definitions come from a portable header instead
 * of Apple's headers, since this is pure static analysis of a downloaded
 * kernelcache buffer, not anything using the host's own Mach-O loader. */
#include "portable_macho.h"
#endif
            ...
            if (seatbeltSandboxPolicyStr)
            {
                ...
                if (nukesb)
                {
                    ...
                    else if (versionFloat >= (float)6.0 && versionFloat < (float)7.0)
                    {
                        ...
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_mount_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_proc_check_get_task)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_deleteextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_exchangedata)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_exec)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_getattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_getextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_listextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_open)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_readlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_revoke)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setflags)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setmode)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setowner)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_setutimes)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_truncate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_unlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_notify_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_uipc_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_vnode_check_uipc_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_proc_check_setauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_proc_check_getauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_proc_check_fork)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops6, mpo_file_check_mmap)), 0x4);
                    }
                    else if (versionFloat >= (float)7.0 && versionFloat < (float)8.0)
                    {
                        PatchLog("%f Sandbox patch\n", versionFloat);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_accepted)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_deliver)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_kqfilter)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_select)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_listen)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_received)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_setsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_getsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_link)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_fsgetpath)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_mount_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_ioctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_label_associate_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_label_associate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_socket_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_mount_check_remount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_mount_check_fsctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_mount_check_mount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_access)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_chroot)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_mount_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_proc_check_get_task)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_deleteextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_exchangedata)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_exec)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_getattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_getextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_listextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_open)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_readlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_revoke)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setflags)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setmode)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setowner)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_setutimes)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_truncate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_unlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_notify_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_uipc_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_vnode_check_uipc_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_proc_check_setauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_proc_check_getauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_proc_check_fork)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops7, mpo_file_check_mmap)), 0x4);
                    }
                    else if (versionFloat >= (float)8.0 && versionFloat < (float)8.1)
                    {
                        PatchLog("%f Sandbox patch\n", versionFloat);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_accepted)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_deliver)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_kqfilter)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_select)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_listen)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_received)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_setsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_getsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_link)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_fsgetpath)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_mount_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_ioctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_label_associate_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_label_associate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_socket_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_mount_check_remount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_mount_check_fsctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_mount_check_mount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_rename)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_access)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_chroot)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_mount_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_proc_check_get_task)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_deleteextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_exchangedata)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_exec)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_getattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_getextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_listextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_open)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_readlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_revoke)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setflags)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setmode)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setowner)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_setutimes)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_truncate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_unlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_notify_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_uipc_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_vnode_check_uipc_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_proc_check_setauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_proc_check_getauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_proc_check_fork)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops80, mpo_file_check_mmap)), 0x4);
                    }
                    else if (versionFloat >= (float)8.1 && versionFloat < (float)9.0)
                    {
                        PatchLog("%f Sandbox patch\n", versionFloat);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_accepted)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_deliver)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_kqfilter)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_select)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_listen)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_received)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_setsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_getsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_link)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_fsgetpath)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_mount_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_ioctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_label_associate_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_label_associate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_socket_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_mount_check_remount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_mount_check_fsctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_mount_check_mount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_rename)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_access)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_chroot)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_mount_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_proc_check_get_task)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_deleteextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_exchangedata)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_exec)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_getattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_getextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_listextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_open)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_readlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_revoke)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setattrlist)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setextattr)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setflags)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setmode)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setowner)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_setutimes)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_stat)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_truncate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_unlink)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_notify_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_uipc_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_vnode_check_uipc_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_proc_check_setauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_proc_check_getauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_proc_check_fork)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops8, mpo_file_check_mmap)), 0x4);
                    }
                    else
                    {
                        PatchLog("%f Sandbox patch\n\n", versionFloat);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_accepted)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_create)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_deliver)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_kqfilter)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_select)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_listen)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_received)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_setsockopt)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_getsockopt)), 0x4);
                        ...
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_mount_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_vnode_check_ioctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_label_associate_accept)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_label_associate)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_socket_check_label_update)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_mount_check_remount)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_mount_check_fsctl)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_mount_check_mount)), 0x4);
                        ...
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_proc_check_get_task)), 0x4);
                        ...
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_vnode_check_revoke)), 0x4);
                        ...
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_vnode_check_uipc_bind)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_vnode_check_uipc_connect)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_proc_check_setauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_proc_check_getauid)), 0x4);
                        bzero(buf + (sbops + offsetof(struct mac_policy_ops90, mpo_proc_check_fork)), 0x4);
                ...
                if (!nukesb)
                {
                    printf("[SKIP] Sandbox policies were NOT patched.\n");
                }
 ...
 * Note: You must disable KASLR to use the sbops patch.
 */
int kernPat10(void *buf, size_t len, char *version, int nukesb)
{
    ...
    while ((uint32_t)i < (uint32_t)(fullSize - 0x8000))
    {
        ...
        if (ii == 6)
        {
            ...
            if (seatbeltSandboxPolicyStr)
            {
                ...
                if (versionFloat == (float)10.0 && nukesb)
                {
                ...
                else if (versionFloat < (float)10.3 && versionFloat > (float)10.0 && nukesb)
                {
                ...
                else if (versionFloat >= (float)10.3 && versionFloat < (float)10.4)
                {
                    if (nukesb)
                    {
        ...
        if (ii == 7)
        {
            ...
            kextbase = find_kextbase(buf, len);
...
int kernPat(void **buf, size_t size, char *versionNumber, int nukesb)
{
    ...
    case 9:
        ...
        break;
    case 10:
        ret = kernPat10(buf, size, versionNumber, nukesb);
        break;
