#!/usr/bin/env python3
"""
build_deb_cache.py — resolve Blackb0x/Misc/packages.txt's flat package-name
...
real, previously-recovered .deb for go in Blackb0x/Misc/local_only_debs.txt
...
Blackb0x/Misc/packages.txt's own names that genuinely resolved through real
...
def main():
    ...
    try:
        ...
        picklist_path.write_text(
            ...
            "# for the package set currently in Blackb0x/Misc/packages.txt.\n"
            + "\n".join(resolved) + "\n"
        )
        ...
        resolved_packages_path.write_text(
            "# Generated by scripts/build_deb_cache.py — do not edit by hand.\n"
            "# The subset of Blackb0x/Misc/packages.txt's own names that genuinely\n"
